      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 font-light max-w-3xl mx-auto">
            Professional development and continuous learning to improve coaching skills
          </p>
        </div>
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (target.parentElement) {
                      target.parentElement.classList.add('bg-gradient-to-br', 'from-primary-500', 'to-blue-500', 'flex', 'items-center', 'justify-center');
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Continuous education and professional development in sports science and coaching
          </p>
